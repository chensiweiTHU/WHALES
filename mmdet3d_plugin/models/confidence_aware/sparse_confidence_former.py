...
class PETRTransformerEncoderLayer(BaseTransformerLayer):
    ...
    def __init__(self,
                 ...
                 with_cp=True,
                 **kwargs):
        super(PETRTransformerEncoderLayer, self).__init__(
            attn_cfgs=attn_cfgs,
            ffn_cfgs=ffn_cfgs,
    ...
    def forward(self, 
        ...
        if self.use_checkpoint and self.training:
            x = cp.checkpoint(
                super(PETRTransformerEncoderLayer, self).forward, 
                query,
                key,
                value,
                query_pos,
            ...
            x = super(PETRTransformerEncoderLayer, self).forward(
            query,
            key=key,
            value=value,
            query_pos=query_pos,
