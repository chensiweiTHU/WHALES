...
import numpy as np
from ..confidence_aware.how2comm_deformable_transformer import RPN_transformer_deformable_mtf_singlescale
...
class SPSPruningFormer(nn.Module):
    def __init__(self, channel, args, idx):
        super(SPSPruningFormer, self).__init__()
