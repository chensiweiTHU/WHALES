...
class VoxelResSPSQuantiseizer(nn.Module):
    ...
    def __init__(self, input_channels, grid_size, spconv_kernel_sizes=[3,3], downsample_pruning_ratio = [0.5,], \
                 channels=[16,32], point_cloud_range=[-3, -46.08, 0, 1, 46.08, 92.16], **kwargs):
        super().__init__()
        ...
        self.conv2 = SparseSequentialBatchdict(
            ...
            PostActBlock(channels[0], channels[1], spconv_kernel_sizes[0], norm_fn=norm_fn, stride=2, \
