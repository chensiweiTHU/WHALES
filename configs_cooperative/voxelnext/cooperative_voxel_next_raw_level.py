...
model = dict(
    type='VoxelNeXtCoopertivePruningRawLevel',
...
lr = 0.001
optimizer = dict(type='AdamW', lr=0.0005, betas=(0.95, 0.99), weight_decay=0.01)
optimizer_config = dict(grad_clip=dict(max_norm=35, norm_type=2))
lr_config = dict(
    policy='cyclic',
    target_ratio=(16, 0.02),
    cyclic_times=2,
    step_ratio_up=0.4)
...
log_level = 'INFO'
load_from = "work_dirs/cooperative_voxel_next_raw_level/epoch_1_best.pth"
resume_from = None
workflow = [('train', 1)]
