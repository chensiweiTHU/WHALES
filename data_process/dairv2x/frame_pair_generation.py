...
if __name__ == "__main__":
    ...
    split_json_path = os.path.join('data_process','dair-v2x','split_datas', 'cooperative-split-data.json')
    print(os.path.abspath(split_json_path))
    ...
    data_infos_train_path = './data_process/dair-v2x/flow_data_jsons/flow_data_info_train.json'
    ...
    data_infos_flow_path = './data_process/dair-v2x/flow_data_jsons/flow_data_info_train_2.json'
    ...
    for async_k in range(0, 6):
        ...
        data_infos_flow_path = './data_process/dair-v2x/flow_data_jsons/flow_data_info_val_' + str(async_k) + '.json'
