...
# print(sys.path)
# cd tools python data_converter/dairv2xconverter/label_world2v.py
import data_converter.dairv2xconverter as dairv2xconverter
from data_converter.dairv2xconverter.utils import read_json, write_json, mkdir_p
