...
train_pipeline = [
    ...
    dict(type='AgentScheduling',
        mode="unicast",
        submode="closest_first", 
        basic_data_limit=8e6
        ),
    dict(
...
data = dict(
    ...
    test=dict(
        ...
        box_type_3d='LiDAR'))
model = dict(
    type='PointPillarOpenCOOD',
    hypes_yaml='configs/cooperative/opencood/point_pillar_early_fusion.yaml',
